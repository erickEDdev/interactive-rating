...
function App() {
  ...
  return (// aparencia --> tamanho/espaçamento --> layout/estrutura
    <div className="bg-[#141519] text-white min-h-dvh w-full max-lg:landscape:py-20 flex justify-center items-center">
      ...
      <Caixa isOpen={isOpen} openModal={openModal} />
      ...
      <Modal
        ...
        className={"bg-[#1f2630] rounded-2xl border-none outline-none w-[90%] lg:w-125 max-lg:landscape:w-[60%] px-7 py-12"}// estilo da caixa
